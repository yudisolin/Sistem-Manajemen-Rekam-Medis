...
<div class="card shadow mb-4">
   ...
   <div class="card-body">
      ...
      <br>
      <?php echo form_open('catatanterintegrasi/create'); ?>
      <form method="post">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-4">
            <input type="text" class="form-control" name="profesi" value="<?php echo $profesi; ?>" readonly>
         </div>
      </div>
      <div class="form-group row">
         <label class="col-sm-2 col-form-label">Catatan</label>
         <div class="col-sm-10">
            <textarea class="form-control" name="catatan" placeholder="Ketikkan pemeriksaan fisik pasien" required autofocus></textarea>
         </div>
      </div>
      <div class="form-group row">
